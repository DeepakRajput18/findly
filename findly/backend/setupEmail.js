...
console.log('🔧 FINDLY EMAIL SETUP ASSISTANT');
console.log('================================\n');
...
console.log('   • Replace "your-app-password-here" with the 16-character app password\n');
...
console.log('   • Go to: http://localhost:5173/forgot-password');
console.log('   • Enter your email address');
console.log('   • Check your inbox for the reset code\n');
...
console.log('   Reset codes will no longer appear only in console logs.\n');